...
class VLAD:
    ...
    def __init__(self, num_clusters: int, 
                ...
                intra_norm: bool=True, norm_descs: bool=False, 
                dist_mode: str="cosine", vlad_mode: str="soft", 
                soft_temp: float=1.0, 
                PlotWhatVLADSees: bool=False,
        ...
        self.PlotWhatVLADSees = PlotWhatVLADSees
    ...
    def generate_res_vec(self, 
        ...
        if cache_id is not None and self.can_use_cache_vlad() and \
            ...
            #print('query_descs:', query_descs.shape)    
