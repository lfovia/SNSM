...
for dataS in 'FLIR' 'INO' 'LLVIP' 'M3FD' 'VOT' 'VTUAV' #
do     
   python All-Backbones-VLAD_bl_9_neighs.py  --upscale_factor=4 --window_size=2 --emb_dim=3136 --backbone=DINOv1 --snsm --encoder=1 --data=$dataS 
