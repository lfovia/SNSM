...
def main():
    ...
    parser.add_argument('--result_save_folder', type=str, default='./ICASSP-Ablation-Exps/9_neighs/1_subtracted/')
    ...
    #qfeats_loc = np.load('./ICASSP-Ablation-Exps/9_neighs/DINOv1b8/SNSM/Boson/scale-4_patchSize_2/thr_patchfeats.npy')
    #dbfeats_loc = np.load('./ICASSP-Ablation-Exps/9_neighs/DINOv1b8/SNSM/Boson/scale-4_patchSize_2/rgb_patchfeats.npy')
