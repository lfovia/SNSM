...
do
   ...
   ###### SNSM on ResNet50      
   python All-Backbones-VLAD_bl.py  --upscale_factor=5 --window_size=2 --emb_dim=4900 --backbone=DINOv1 --snsm --encoder=1 --data=$dataS 
   python All-Backbones-VLAD_bl.py  --upscale_factor=5 --window_size=4 --emb_dim=1225 --backbone=DINOv1 --snsm --encoder=1 --data=$dataS 
   python All-Backbones-VLAD_bl.py  --upscale_factor=5 --window_size=5 --emb_dim=784 --backbone=DINOv1 --snsm --encoder=1 --data=$dataS 
   python All-Backbones-VLAD_bl.py  --upscale_factor=5 --window_size=7 --emb_dim=400 --backbone=DINOv1 --snsm --encoder=1 --data=$dataS 
   python All-Backbones-VLAD_bl.py  --upscale_factor=5 --window_size=10 --emb_dim=196 --backbone=DINOv1 --snsm --encoder=1 --data=$dataS
   python All-Backbones-VLAD_bl.py  --upscale_factor=5 --window_size=14 --emb_dim=100 --backbone=DINOv1 --snsm --encoder=1 --data=$dataS
   python All-Backbones-VLAD_bl.py  --upscale_factor=5 --window_size=20 --emb_dim=49 --backbone=DINOv1 --snsm --encoder=1 --data=$dataS
   python All-Backbones-VLAD_bl.py  --upscale_factor=5 --window_size=28 --emb_dim=25 --backbone=DINOv1 --snsm --encoder=1 --data=$dataS
   python All-Backbones-VLAD_bl.py  --upscale_factor=5 --window_size=35 --emb_dim=16 --backbone=DINOv1 --snsm --encoder=1 --data=$dataS
   python All-Backbones-VLAD_bl.py  --upscale_factor=5 --window_size=70 --emb_dim=4 --backbone=DINOv1 --snsm --encoder=1 --data=$dataS
