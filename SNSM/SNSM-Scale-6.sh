...
for dataS in 'Boson' 'FLIR' 'INO' 'LLVIP' 'M3FD' 'VOT' 'VTUAV' #
do
   ...
   ###### SNSM on ResNet50      
   python All-Backbones-VLAD_bl.py  --upscale_factor=6 --window_size=2 --emb_dim=7056 --backbone=DINOv1 --snsm --encoder=1 --data=$dataS 
   python All-Backbones-VLAD_bl.py  --upscale_factor=6 --window_size=3 --emb_dim=3136 --backbone=DINOv1 --snsm --encoder=1 --data=$dataS 
   python All-Backbones-VLAD_bl.py  --upscale_factor=6 --window_size=4 --emb_dim=1764 --backbone=DINOv1 --snsm --encoder=1 --data=$dataS 
   python All-Backbones-VLAD_bl.py  --upscale_factor=6 --window_size=6 --emb_dim=784 --backbone=DINOv1 --snsm --encoder=1 --data=$dataS 
   python All-Backbones-VLAD_bl.py  --upscale_factor=6 --window_size=7 --emb_dim=576 --backbone=DINOv1 --snsm --encoder=1 --data=$dataS
   python All-Backbones-VLAD_bl.py  --upscale_factor=6 --window_size=8 --emb_dim=441 --backbone=DINOv1 --snsm --encoder=1 --data=$dataS
   python All-Backbones-VLAD_bl.py  --upscale_factor=6 --window_size=12 --emb_dim=196 --backbone=DINOv1 --snsm --encoder=1 --data=$dataS
   python All-Backbones-VLAD_bl.py  --upscale_factor=6 --window_size=14 --emb_dim=144 --backbone=DINOv1 --snsm --encoder=1 --data=$dataS
   python All-Backbones-VLAD_bl.py  --upscale_factor=6 --window_size=21 --emb_dim=64 --backbone=DINOv1 --snsm --encoder=1 --data=$dataS 
   python All-Backbones-VLAD_bl.py  --upscale_factor=6 --window_size=24 --emb_dim=49 --backbone=DINOv1 --snsm --encoder=1 --data=$dataS
   python All-Backbones-VLAD_bl.py  --upscale_factor=6 --window_size=28 --emb_dim=36 --backbone=DINOv1 --snsm --encoder=1 --data=$dataS
   python All-Backbones-VLAD_bl.py  --upscale_factor=6 --window_size=42 --emb_dim=16 --backbone=DINOv1 --snsm --encoder=1 --data=$dataS
   python All-Backbones-VLAD_bl.py  --upscale_factor=6 --window_size=56 --emb_dim=9 --backbone=DINOv1 --snsm --encoder=1 --data=$dataS
   python All-Backbones-VLAD_bl.py  --upscale_factor=6 --window_size=84 --emb_dim=4 --backbone=DINOv1 --snsm --encoder=1 --data=$dataS
